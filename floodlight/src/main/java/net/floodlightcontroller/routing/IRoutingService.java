...
public interface IRoutingService extends IFloodlightService {
	...
	public static enum PathOrderingCriteria {
		DEFAULT, DELAY, BANDWIDTH_UTILIZATION
	}
	
	public void setPathOrderingCriteria(PathOrderingCriteria criteria);
     ...
     * @param cookie cookie (usage determined by implementation; ignored by topology instance now).
     */
    public Route getPath(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 cookie);
     ...
     * @param tunnelEnabled boolean option.
     */
    public Route getPath(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 cookie, boolean tunnelEnabled);

    /** return all routes, if available */
    public ArrayList<Route> getPaths(DatapathId longSrcDpid, DatapathId longDstDpid, boolean tunnelEnabled);
