...
public class RouteResource extends ServerResource {
    ...
    public List<NodePortTuple> retrieve() {
        ...
        Route result = routing.getPath(longSrcDpid, shortSrcPort, longDstDpid, shortDstPort, U64.of(0));
        
        if (result != null) {
            return routing.getPath(longSrcDpid, shortSrcPort, longDstDpid, shortDstPort, U64.of(0)).getPath();
        }
        else {
