...
public class ForwardingTest extends FloodlightTestCase {
	...
	public void testForwardMultiSwitchPath() throws Exception {
		...
		expect(routingEngine.getPath(DatapathId.of(1L), OFPort.of(1), DatapathId.of(2L), OFPort.of(3), U64.ZERO)).andReturn(route).atLeastOnce();
	...
	public void testForwardSingleSwitchPath() throws Exception {
		...
		expect(routingEngine.getPath(DatapathId.of(1L), OFPort.of(1), DatapathId.of(1L), OFPort.of(3), U64.ZERO)).andReturn(route).atLeastOnce();
